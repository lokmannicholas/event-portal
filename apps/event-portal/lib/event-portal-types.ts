...
export interface EventPortalEventEntity extends StrapiDocumentBase {
  ...
  smsRegistrationNoticeTemplate?: StrapiOneRelation<EventPortalNoticeTemplateEntity>;
  smsAnnouncementNoticeTemplate?: StrapiOneRelation<EventPortalNoticeTemplateEntity>;
  smsEventUpdateNoticeTemplate?: StrapiOneRelation<EventPortalNoticeTemplateEntity>;
  emailRegistrationNoticeTemplate?: StrapiOneRelation<EventPortalNoticeTemplateEntity>;
  emailAnnouncementNoticeTemplate?: StrapiOneRelation<EventPortalNoticeTemplateEntity>;
  emailEventUpdateNoticeTemplate?: StrapiOneRelation<EventPortalNoticeTemplateEntity>;
  userPartition?: StrapiOneRelation<EventPortalUserPartitionEntity>;
...
export interface EventPortalEventCreateInput {
  ...
  releasedAt?: string;
  publicBaseUrl?: string;
  smsRegistrationNoticeTemplate?: StrapiRelationInput;
  smsAnnouncementNoticeTemplate?: StrapiRelationInput;
  smsEventUpdateNoticeTemplate?: StrapiRelationInput;
  emailRegistrationNoticeTemplate?: StrapiRelationInput;
  emailAnnouncementNoticeTemplate?: StrapiRelationInput;
  emailEventUpdateNoticeTemplate?: StrapiRelationInput;
